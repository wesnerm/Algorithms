...
{
    Vertex[] vertices;
    internal readonly List<EdgePair> Edges = new List<EdgePair>();
    int n;
    int log2N;
    ...
    void ValidateGraph(bool skipConn = false)
    {
        ...
        for (var i = 0; i < Edges.Count; ++i)
        {
            ...
            if (e.E.Euler != null)
            {
                ...
                for (var j = 0; j < e.E.Euler.Count; ++j)
                {
    ...
    {
        return vertices[i].Connected(vertices[j]);
    }
}
