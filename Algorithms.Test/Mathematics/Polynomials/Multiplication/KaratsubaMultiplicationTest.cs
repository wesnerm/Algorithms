...
public class KaratsubaMultiplicationTest : FftTestBase
{
    ...
    protected override long[] Multiply(long[] a, long[] b) => KaratsubaMultiplication.Karatsuba(a, b, 0, MOD);
    ...
    //    for (int i = 0; i < size; ++i) {
    //        in1[i] = r.NextInt64(0, MOD);
    //        in2[i] = r.NextInt64(0, MOD);
    //    }
    ...
    //{
    //    long[] expected = Polynomial.MultiplyPolynomialsMod(poly1, poly2, 1000000007);
