...
using FWT = FastWalshTransform3;

[TestFixture]
public class FastWalshTransformTest
{

    public int[] A2 = new int[] { 1, 2, 3, 4, 5, 6, 7, 8 };
    public int[] B2 = new int[] { 1, 2, 4, 8, 16, 32, 64, 128 };

    public int[] A3 = new int[] { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
    public int[] B3 = new int[] { 1, 2, 4, 8, 16, 32, 64, 128, 256 };
    ...
    static int Combine(int a, int b)
    {
        ...
        var x = (a & mask1 * 3) + (b & mask1 * 3);
        var y = (a & mask2 * 3) + (b & mask2 * 3);
        return 0
