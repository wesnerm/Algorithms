...
public class NumberToolsTest
{
    ...
    public void AreClose()
    {
        ...
        Assert.Fail("AreClose is inconclusive");
    }
    ...
    public void Chop()
    {
        ...
        Assert.Fail("Chop is inconclusive");
    }
    ...
    public void ExtendedGCD()
    {
        var x = 7;
        var y = 23;
        var gcd = ExtendedGcd(x, y, out int xF, out int yF);
    ...
    public void GCD()
    {
        ...
        Assert.Fail("GCD is inconclusive");
    }
    ...
    public void IsDivisible()
    {
        ...
        Assert.Fail("IsDivisible is inconclusive");
    }
    ...
    public void IsOne()
    {
        ...
        Assert.Fail("IsOne is inconclusive");
    }
    ...
    public void IsZero()
    {
        ...
        Assert.Fail("IsZero is inconclusive");
    }
    ...
    public void QuadraticRoots()
    {
        ...
        Assert.Fail("QuadraticRoots is inconclusive");
    }
