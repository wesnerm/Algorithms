...
public class NumericalTest
{
    ...
    public void EuclidTest()
    {
        ...
        // expected: 2 -2 1
        int x, y;
        var d = ExtendedEuclid(14, 30, out x, out y);
        AreEqual(2, d);
        AreEqual(-2, x);
        AreEqual(1, y);

        // expected: 95 45
        var sols = ModularLinearEquationSolver(14, 30, 100);
        ...
        var ret = ChineseRemainderTheorem(xs.GetRange(0, 3), a.GetRange(0, 3));
    ...
    public void GaussJordanTest()
    {
        ...
        var det = LinearAlgebra.GaussJordan(a, b);
        ...
        var A = new double[,]
{
        ...
        var b = new double[] { 10, -4, 5, -5 };
        var c = new double[] { 1, -1, 0 };

        var solver = new LpSolver(A, b, c);
        var value = solver.Answer;
        var x = solver.OptimalVariables;
    ...
    public void RrefTest()
    {
        ...
        var rank = LinearAlgebra.ReducedRowEchelonForm(a);
