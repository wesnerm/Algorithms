...
public class FactorizationTest
{
    ...
    {
        var table = Factorization.PrimeFactorsUpTo(1000);

        for (int i = 1; i <= 100; i++)
        {
            var primes = Factorization.DistinctPrimeFactorsOf(table, i).ToList();
            Assert.AreEqual(i-Factorization.TotientFunction(table, i),
