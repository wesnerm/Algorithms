...
public class WeakSetTest 
{
    ...
    private readonly object[] _strongOdds = {1, 3, 5, 7, 9};

    private readonly object[] _strongStrings =
    {
        "Alpha", "Beta", "Gamma", "Delta", "Epsilon",
        "Iota", "Kappa", "Lambda", "Mu"
    };

    private WeakSet _numbers;
    private WeakSet _numbers37;
    private WeakSet _strings;
    private WeakSet _allWeak;
    private WeakSet _allStrong;
    private WeakSet[] _basket;

    public void Validate(WeakSet set)
    {
        var count = set.Count;
        var actualCount = set.ActualCount;
    ...
    public void Enumerators()
    {
        ...
        Assert.IsTrue(count >= _numbers.Count);
        count = _numbers.Count;
        Assert.IsTrue(count >= _numbers.ActualCount);
    }
    ...
    public void Properties()
    {
        foreach (var ws in _basket)
        {
            IsTrue(ws.Count >= ws.ActualCount);
        }
    }
