...
public class HeapTest
{
    ...
    private IndexedMinHeap<int> sample;
    private IndexedMinHeap<int> reverse;
    private IndexedMinHeap<int> odds;
    private IndexedMinHeap<int> evens;
    private IndexedMinHeap<int> empty;
    ...
    {
        Assert.Throws<InvalidOperationException>(()=>empty.Top());
    }
    ...
    public void Limit()
    {
        ...
        AreEqual(4, list.Top());
        var array = list.ExtractSortedList().ToArray();
