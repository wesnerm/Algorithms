...
public class VanEmdeBoasTreeTest
{
    ...
    {
        var T = new int[] { 1, 2, 4, 8, 10, 16, 32, 64, 100, 128, 256, 512, 1000, 1024, 2048, 4096, 8092, 10000, 16384, 32768, 65536, 100000, 131072, 262144, 524288, 1000000 };
        foreach (var m in T)
        {
    ...
    {
        var veb = new VanEmdeBoasTree(1000 * 1000 * 1000);
    ...
    public void DeletionTest()
    {
        ...
        Assert.True(veb.Delete(30000000));
        count--;
        Assert.AreEqual(count, veb.Count);
