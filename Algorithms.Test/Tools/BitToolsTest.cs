...
public class BitToolsTest
{
    ...
    public void HighestBitUsingFloat2Test()
    {
        ...
        {
            var b = 1L << i;
            var j = HighestBitUsingFloatCompactAccurateZero(b);
            Console.WriteLine($"1 << {i} = {b} -> {j}");
            AreEqual(b, j);
        }
    }
    ...
    public void HighestBitUsingFloat4Test()
    {
        ...
        {
            var b = 1L << i;
            var j = HighestBitUsingFloatRoundTrip(b);
            Console.WriteLine($"1 << {i} = {b} -> {j}");
            AreEqual(b, j);
        }
    }
    ...
    public static unsafe int LogUsingDeBruin(long value)
    {
        value |= value >> 1;
        value |= value >> 2;
        value |= value >> 4;
    ...
    public static unsafe int LogUsingDeBruin(int value)
    {
        value |= value >> 1;
        value |= value >> 2;
        value |= value >> 4;
