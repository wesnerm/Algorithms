...
public static partial class Numbers
{
    ...
    public new static bool Equals(object num1, object num2)
    {
    ...
    [DebuggerStepThrough]
    public static bool IsNormalNumber(double d)
    {
        return d < double.PositiveInfinity && d > double.NegativeInfinity;
    }

    [DebuggerStepThrough]
    public static bool IsZeroed(double d)
    {
    ...
    [DebuggerStepThrough]
    public static bool IsGreaterEqual(double num1, double num2)
    {
        return Compare(num1, num2) >= 0;
    }
    ...
    [DebuggerStepThrough]
    public static bool IsLessEqual(double num1, double num2)
    {
        return Compare(num1, num2) <= 0;
    }
    ...
    {
        var den = oldEnd - oldStart;
        if (den == 0)
            return value;

        var result = newStart + (value - oldStart)*(newEnd - newStart)/den;
        return result;
    }
