...
public static class NumberTheory
{
    ...
    {
        var gcd = ExtendedGcd(x, mod, out var xFactor, out var modFactor);
        Debug.Assert(gcd == 1);
    ...
    {
        var gcd = ExtendedGcd(x, mod, out var xFactor, out _);
    ...
    {
        var gcd = ExtendedGcd(x, y, out var xFactor2, out long yFactor2);
    ...
    public static long Gcd(long x, long y, out long xf, out long yf)
    {
        ...
        long gcd = Gcd(y % x, x, out yf, out var xf2);
        xf = xf2 - yf * (y / x);
        return gcd;
    }
    ...
    public static long ExtendedGcd(long x, long y, out long xFactor, out long yFactor)
    {
        ...
        gcd = ExtendedGcd(rem, x, out yFactor, out var xFactor2);
