...
public struct BigDouble : IFormattable, IEquatable<BigDouble>, IComparable<BigDouble>
{
    ...
    public static implicit operator BigDouble(double d) => new BigDouble(d);
    ...
    public static BigDouble operator -(BigDouble d1) => new BigDouble(-d1.hi, -d1.lo);
    ...
    public static BigDouble operator /(BigDouble d1, BigDouble d2)
        => new BigDouble(d1.hi / d2.hi, d1.lo / d2.hi);
    ...
    public BigDouble Truncate() => new BigDouble(Math.Truncate(hi), Math.Truncate(lo));
