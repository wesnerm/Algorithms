...
public struct Gaussian
{
    ...
    #region Properties
    public Gaussian Conjugate=> new Gaussian(Real, -Imag);
    ...
    public static Gaussian operator +(Gaussian arg1, Gaussian arg2) 
        => new Gaussian(arg1.Real + arg2.Real, arg1.Imag + arg2.Imag);

    public static Gaussian operator -(Gaussian arg1) 
        => new Gaussian(-arg1.Real, -arg1.Imag);
    ...
    public static bool operator ==(Gaussian c1, Gaussian c2) 
        => c1.Real == c2.Real && c1.Imag == c2.Imag;

    public static bool operator !=(Gaussian c1, Gaussian c2) 
        => c1.Real != c2.Real || c1.Imag != c2.Imag;

    public static bool operator ==(Gaussian c1, long c2) 
        => c1.Real == c2 && c1.Imag == 0;

    public static bool operator !=(Gaussian c1, long c2) 
        => c1.Real != c2 || c1.Imag != 0;

    public static implicit operator Gaussian(long d) 
        => new Gaussian(d, 0);
    ...
    public override bool Equals(object obj) 
        => obj is Gaussian && (Gaussian) obj == this;
