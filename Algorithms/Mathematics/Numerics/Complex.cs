...
public struct Complex
{
    ...
    public static Complex operator +(Complex arg1, Complex arg2) =>
        new Complex(arg1.Real + arg2.Real, arg1.Imag + arg2.Imag);

    public static Complex operator -(Complex arg1) 
        => new Complex(-arg1.Real, -arg1.Imag);

    public static Complex operator -(Complex arg1, Complex arg2) => 
        (new Complex(arg1.Real - arg2.Real, arg1.Imag - arg2.Imag));

    public static Complex operator *(Complex arg1, Complex arg2) => 
        (new Complex(arg1.Real*arg2.Real - arg1.Imag*arg2.Imag, arg1.Real*arg2.Imag + arg2.Real*arg1.Imag));
    ...
    public static Complex Polar(double r, double theta) => new Complex(r*Math.Cos(theta), r*Math.Sin(theta));
