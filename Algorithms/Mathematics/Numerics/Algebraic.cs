...
namespace Algorithms.Mathematics
{
    public struct Algebraic
    {
        ...
        #region Properties
        public Algebraic Conjugate => new Algebraic(X, -Y, S);
        ...
        public static Algebraic operator +(Algebraic a, Algebraic b)
            => new Algebraic(a.X + b.X, a.Y + b.Y, a.S | b.S);

        public static Algebraic operator -(Algebraic a, Algebraic b)
            => new Algebraic(a.X - b.X, a.Y - b.Y, a.S | b.S);

        public static Algebraic operator -(Algebraic a)
            => new Algebraic(-a.X, -a.Y, a.S);

        public static Algebraic operator *(Algebraic a, Algebraic b) =>
            new Algebraic(a.X * b.X + a.Y * b.Y * a.S,
                a.X * b.Y + a.Y * b.X, a.S | b.S);

        public static Algebraic operator *(Algebraic a, long b) =>
            new Algebraic(a.X * b, a.Y * b, a.S);

        public static Algebraic operator /(Algebraic a, long d) =>
            new Algebraic(a.X / d, a.Y / d, a.S);
        ...
        public static implicit operator Algebraic(long a)
            => new Algebraic(a, 0, 0);

        public static bool operator ==(Algebraic c1, Algebraic c2)
            => c1.X == c2.X && c1.Y == c2.Y;

        public static bool operator !=(Algebraic c1, Algebraic c2)
            => c1.X != c2.X || c1.Y != c2.Y;

        public static bool operator ==(Algebraic c1, long c2)
            => c1.X == c2 && c1.Y == 0;
        ...
        public override bool Equals(object obj)
            => obj is Algebraic && (Algebraic)obj == this;

        public override int GetHashCode()
            => (((long)Y.GetHashCode() << 24) ^ X).GetHashCode();
