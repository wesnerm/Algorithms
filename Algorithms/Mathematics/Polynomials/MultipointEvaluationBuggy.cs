...
public class MultipointEvaluationBuggy
{
    long[][] _tree;
    long[] _xs;
    long[] _result;
    ...
    public MultipointEvaluationBuggy(int n)
    {
        _tree = new long[4 * HighestOneBit(n - 1)][];
    }
    ...
    public long[] Evaluate(long[] coefs, long[] xs)
    {
        ...
        ChineseRemainderTheorem(coefs, 0, xs.Length, 0);
        return _result;
    }
