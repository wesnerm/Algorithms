...
public static class InterpolationMod
{
    ...
    /// </summary>
    /// <param name="y">Must be a list of points for x in [0, deg],
    /// where degree is the expected degree of the interpolating polynomial </param>
    ...
    {
        var mat = VandermondeMatrix(xs, mod);
    ...
    {
        var invL = InverseL(xs);
        var invU = InverseU(ys);
