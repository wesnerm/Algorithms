...
public unsafe class Conv64
{
    struct T
    {
        ...
        public static implicit operator T(long x)
        {
            return new T(x, 0);
        }
        ...
        public T conj() => new T(a - b, - b);

        public static T operator -(T x) => new T(- x.a, - x.b);

        public static T operator +(T u, T v) => new T(u.a + v.a, u.b + v.b);

        public static T operator -(T u, T v) => new T(u.a - v.a, u.b - v.b);

        public static T operator *(T u, T v) => new T(u.a * v.a - u.b * v.b, u.b * v.a + u.a * v.b - u.b * v.b);
    }
    ...
    static readonly T OMEGA = new T(0, 1);
    static readonly T OMEGA2 = new T(-1, -1);
    static readonly T INV3 = new T(unchecked((long)12297829382473034411ul), 0);
    ...
    public long[] Multiply(ReadOnlySpan<long> p, ReadOnlySpan<long> q)
    {
        ...
        var res = new long[s];
        fixed (long* pRes = (long[])(object)res)
        fixed (long* ppp = pp)
        fixed (long* pqq = qq)
