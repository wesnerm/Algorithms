...
public class EulerianPath
{
    ...
    {
        var odds = Directed ? FindDirectedOddEdges() : FindOddEdges();
        if (odds == null)
            return null;
    ...
    private int[] FindDirectedOddEdges()
    {
    ...
    private List<int> FindEulerianPath(int v1, int v2)
    {
        var cycle = FindEulerianCycle(v1, v2);
        if (cycle != null)
        {
            int xor = v1 ^ v2;
    ...
    private List<int> FindEulerianCycle(int v1, int v2 = -1)
    {
