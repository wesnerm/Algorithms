...
public static class TestGenerator
{
    ...
    public static int[] RandomArray(int size, int min, int max, bool distinct = false)
    {
        ...
        {
            int v;
            do v = rand.Next(min, max + 1); while (distinct && !set.Add(v));
            result[i] = v;
        }
        return result;
    }

    public static string Join(this IEnumerable list, string delim =" ")
    {
    ...
    {
        return RandomString(n, chars, distinct).ToCharArray();
    }

    public static string RandomPattern(string s, int n = 0)
    {
        throw new NotImplementedException();
    }
    ...
    public static int[] Relabel(int[] tree, int[] perm=null, int offset=0)
    {
        ...
        var result = new int[tree.Length];
    ...
    public static List<int>[] RandomGraph(int n, int edges)
    {
        throw new NotImplementedException();
    }

    public static List<int>[] RandomBipartiteGraph(int n, int edges)
    {
        throw new NotImplementedException();
    }

    public static List<int>[] RandomDirectedGraph(int n, int edges)
    {
        throw new NotImplementedException();
    }
