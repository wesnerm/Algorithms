...
{
    private int deriv; // 1=difference, 0=function, -1=summation
    ...
    public RangeSumOffline(long[] array, bool clone = true)
    {
    ...
    public long this[int i]
    {
        get
        {
            if (deriv != 0) { if (deriv == -1) return QueryInclusive(i, i); else GoToDerivative(0); };
            return A[i];
        }
        set
        {
