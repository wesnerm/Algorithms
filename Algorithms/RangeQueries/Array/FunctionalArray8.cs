...
public abstract class FunctionalArray8
{
    ...
    protected class Empty : FunctionalArray8
    {
        ...
        public override STType this[int index] => default(STType);
    ...
    protected class Singleton : FunctionalArray8
    {
        ...
        public override STType this[int index] => Index == index ? Value : default(STType);
        ...
        public override FunctionalArray8 SetIndex(int index, STType value)
        {
            ...
            var zero = Create(Length + 7 >> 3);
            var clone = new Node();
            clone.Item0 = clone.Item1 = clone.Item2 = clone.Item3 = clone.Item4 = clone.Item5 = clone.Item6 = clone.Item7 = zero;
    ...
    protected class Node : FunctionalArray8
    {
        ...
        public override STType this[int index]
        {
            get
            {
                return GetItem(index & 7)[index >> 3];
            }
        }
