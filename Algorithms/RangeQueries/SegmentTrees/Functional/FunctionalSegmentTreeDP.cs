...
public partial class FunctionalSegmentTreeDP
{
    ...
    public STType GetSum(int start, int end)
    {
        ...
        int mid = Left.Length;
        var left = Left.GetSum(start, end);
        var right = Right.GetSum(start - mid, end - mid);
    ...
    {
        return left != Left || right != Right ? new FunctionalSegmentTreeDP(left, right) : this;
    }
    #endregion
