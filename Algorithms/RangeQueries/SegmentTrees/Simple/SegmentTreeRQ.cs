...
public partial class SegmentTreeRQ
{
    #region Variables
    public STType Sum;
    private readonly SegmentTreeRQ Left, Right;
    public int Length;
    #endregion
    ...
    public STType Query(int start, int end)
    {
        ...
        int mid = Left.Length;
        var left = Left.Query(start, end);
        var right = Right.Query(start - mid, end - mid);
