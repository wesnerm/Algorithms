...
public class OrderedSequenceCheck
{
    ...
    public static readonly OrderedSequenceCheck Bad = new OrderedSequenceCheck();

    private OrderedSequenceCheck() { }
    ...
    public OrderedSequenceCheck Reverse()
    {
        ...
        s.LeftNumber = this.RightNumber;
        s.RightNumber = this.LeftNumber;
        s.LeftGap = this.RightGap;
        s.RightGap = this.LeftGap;
        s.LeftValid = this.RightValid;
        s.RightValid = this.LeftValid;
        return s;
    }
    ...
    public static OrderedSequenceCheck operator +(OrderedSequenceCheck s1, OrderedSequenceCheck s2)
    {
        ...
        if (s.Combos != 0)
            s.Combos = (int)(s.Combos * OrderedSequenceCheck.ComputePossible(available, innerGap, true) % MOD);
        s.CombosSame = (int)(s.CombosSame * OrderedSequenceCheck.ComputePossible(available + 2, innerGap, false) % MOD);
        return s;
    }
    ...
    public override string ToString()
    {
        ...
        var s = $"{LeftNumber}{op}{RightNumber}";
